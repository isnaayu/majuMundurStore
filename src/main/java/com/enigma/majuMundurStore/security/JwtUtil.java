package com.enigma.majuMundurStore.security;
...
public class JwtUtil {
    @Value("${app.majuMundurStore.jwt.jwt-secret}")
    private String jwtSecret;
    @Value("${app.majuMundurStore.jwt.app-name}")
    private String appName;

    @Value("${app.majuMundurStore.jwt.jwtExpirationInSecond}")
